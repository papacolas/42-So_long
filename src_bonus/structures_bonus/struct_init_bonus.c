...
/*   Updated: 2025/04/08 15:19:22 by ncrivell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	struct_textures_init(t_textures *textures)
{
	...
	textures->enemy.width = 0;
	textures->enemy.height = 0;
}
...
void	struct_vars_init(t_vars *vars)
{
	...
	vars->enemy_squad = 0;
	vars->end_game = 0;
	vars->speed_bandits = 0;
	vars->moves_count = 0;
	vars->exit_start.tv_sec = 0;
	vars->exit_start.tv_usec = 0;
	vars->exit_timer.tv_sec = 0;
	vars->exit_timer.tv_usec = 0;
	vars->exit_blink = 0;
